...
class AppConfigAdmin():      
    def __init__(self, Init):
        self.tela_render = "AppConfigAdmin"
        self.Init = Init
        ...
        self.btn_home = Button(self.menu_logado, text="Área Admin", 
                                font= tkFont.Font(size=10), bg="#00767d", 
                                fg= "#ffffff", command=lambda:[Init.control.renderTela('AppInitAdmin')])
    ...
    def formularioFuncionario(self):
        ...
        #puxando dados
        self.idfuncionario = self.Init.session['idusuario']
        ...
        foto_perfil = self.dados_funcionario[8]
        ...
        self.btn_salvar = Button(self.frame_formulario, text="SALVAR", bg="#ffffff", fg= "#000000", command=lambda:[FuncionarioController.alterarFuncionario(self, self.Init)])
